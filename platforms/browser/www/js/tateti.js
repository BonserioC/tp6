(function (win, doc, undefined)
{
    ...
    var game = {
        ...
        ,   generateBoard: function ()
            {
                ...
                this.board.style.width = 100 * size + 'px';
                this.board.style.height = 100 * size + 'px';
        ...
        ,   celebrate: function ()
            {
                if (this.winner)
                    this.marker.innerHTML = 'Ganó el jugador numero <b class="player-' + this.winner + '">' + this.winner + ' :D</b>';
                else
                    this.marker.innerHTML = 'Es un empate <b>:O</b>';
